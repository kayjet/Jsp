    ...
    <div class="rel m0a wd1200 htauto">
        ...
        <div class="item_container">
            <div class="item_left fl" style="background:url(images/f940ef38ac9309d1f91a1805241b381c.gif)">
                ...
                <!--	<jsp:useBean id="bean" class="bean.produtionsBean"/>
                    <jsp:getProperty name="bean" property="itemName"/>-->
                    
                    <%= ((bean.produtionsBean)request.getSession().getAttribute("bean")).getItemName() %>
